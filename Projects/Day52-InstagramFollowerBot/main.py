...
SIMILAR_ACCOUNT = "ACCOUNT NAME TO FIND SIMILAR ACCOUNTS"
...
class InstaFollower:
    ...
    def login(self):
        ...
        time.sleep(3)
        insta_username = self.driver.find_element(By.XPATH, "//*[@id='loginForm']/div/div[1]/div/label/input")
        insta_username.send_keys(USERNAME)
        insta_password = self.driver.find_element(By.XPATH, "//*[@id='loginForm']/div/div[2]/div/label/input")
